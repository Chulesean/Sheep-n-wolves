...
#             moves.update(self._traverse_direction(piece, dr, dc))
        
#         return moves
    
#     def _traverse_direction(self, piece, dr, dc):
#         moves = {}
...
#             if current is None:
#                 if skipped:
#                     moves[(row, col)] = skipped.copy()
                    
#                     if piece.king:
#                         self._find_further_captures(piece, row, col, dr, dc, skipped, moves)
#                 else:
#                     if piece.king or abs(row - piece.row) == 1:
#                         moves[(row, col)] = []

#                 if piece.king and not skipped:
#                     continue
#                 else:
#                     break                    
...
#     def _find_further_captures(self, piece, start_row, start_col, dr, dc, already_captured, moves):
#         directions = [(-1, -1), (-1, 1), (1, -1), (1, 1)]
...
#                 if current is None:
#                     if new_captured:
#                         if not any(captured.row == new_captured[0].row and 
#                                   captured.col == new_captured[0].col 
#                                   for captured in already_captured):
                            
#                             moves[(row, col)] = already_captured + new_captured

#                             self._find_further_captures(piece, row, col, ndr, ndc, 
#                                                       already_captured + new_captured, moves)
#                         break
#                 elif current.color == piece.color:
#                     break
#                 else: 
